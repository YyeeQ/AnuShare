...
public class ModerationToolsAddReportTests {
	...
	public void addReportSucceedsAfterReportWasRetracted() {
		...
		assertTrue(ModerationTools.addReport(message.id(), reporter.id(), 10L));
		assertTrue(ModerationTools.removeReport(message.id(), reporter.id()));
		assertFalse(ModerationTools.hasReported(message.id(), reporter.id()));
	...
	public void removeReportCoversAllGuardBranches() {
		...
		assertFalse(ModerationTools.removeReport(null, reporter.id()));
		assertFalse(ModerationTools.removeReport(message.id(), null));
		assertFalse(ModerationTools.removeReport(null, null));
		assertFalse(ModerationTools.removeReport(UUID.randomUUID(), reporter.id()));
		assertFalse(ModerationTools.removeReport(message.id(), UUID.randomUUID()));
		assertFalse(ModerationTools.removeReport(message.id(), reporter.id()));
